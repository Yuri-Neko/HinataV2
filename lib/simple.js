...
/**
    ...
    */
    sendButtonDoc: {
             ...
             * @param {Object} options
             */
             value(jid, text = '', author, image, button, quoted, options) {
                return typeof image === 'undefined' || image === null || image === '' ? conn.sendMessage(jid, { ...options, text }, { quoted, ...options }) : conn.sendFile(jid, image, author, text, quoted, false, options)
