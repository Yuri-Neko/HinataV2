    ...
    sendButtonDoc: {
             ...
             */
             value(jid, text = '', footer, image, button, quoted, options) {
                return !image || !image.startsWith('http') ? conn.sendMessage(jid, { ...options, text: text + '\n\n' + footer }, { quoted, ...options }) : conn.sendFile(jid, image, author, text + '\n\n' + footer, quoted, false, options)
