...
if (command == 'ceksifat') {
await conn.sendButton(m.chat, cksft, author, flaaa.getRandom() + command, [['🎀 Menu', '/menu']], m, { mentions: conn.parseMention(cksft), fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
          externalAdReply :{
    mediaUrl: sig,
    mediaType: 2,
    description: wm, 
  ...
  await conn.sendButton(m.chat, msdpn, author, flaaa.getRandom() + command, [['🎀 Menu', '/menu']], m, { mentions: conn.parseMention(msdpn), fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
          externalAdReply :{
    mediaUrl: sig,
    mediaType: 2,
    description: wm, 
